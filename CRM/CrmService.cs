...
namespace student2.CRM
{
    ...
    public class CrmService
    {
        ...
        public CrmServiceClient conn;  //Allows us to connect to CRM from anywhere
        public static IConfigurationRoot Configuration { get; set; } //allows us to read the secret jason file
        ...
        public CrmService()
        {
            ...
            conn = new CrmServiceClient(credentials,
               "stu16-02.crm.eperformanceinc.com",             
               "443",
               "stu16-02", useUniqueInstance: true, useSsl: true);
